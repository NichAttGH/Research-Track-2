...
import random	# Added for Research Track 2 Third Assignment
    ...
    def __init__(self, objects=None, wall_markers=False):
        ...
        def place_token_circle(radius, number_offset=0, angle_offset=0.25 * pi,
            ...
            for i in range(TOKENS_PER_CIRCLE):
                ...
                token.location = (random.uniform(-2,2), random.uniform(-2,2))	# Added for Research Track 2 Third Assignment
